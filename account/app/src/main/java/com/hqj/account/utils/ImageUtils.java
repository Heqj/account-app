...
public class ImageUtils
{
    ...
    public static void imgToView(Bitmap bitmap, ImageView view) {
        InputStream is;
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            bitmap.compress(Bitmap.CompressFormat.JPEG, 50, baos);
            is = new ByteArrayInputStream(baos.toByteArray());
            ImageUtils.ImageSize actualImageSize = getImageSize(is);
            ImageUtils.ImageSize imageViewSize = getImageViewSize(view);
