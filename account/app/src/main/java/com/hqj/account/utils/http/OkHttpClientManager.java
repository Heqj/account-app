/*
package com.hqj.account.utils.http;
...
/**
    ...
    private Response _postAsyn(String url, Map<String, String> params) throws IOException
    {
    ...
    private void _downloadAsyn(final String url, final String destFileDir, final ResultCallback callback)
    {
        ...
        call.enqueue(new Callback()
        {
            ...
            public void onResponse(Response response)
            {
                ...
                try
                {
                    HttpUtils.syncCookie(response); //同步cookie
...
/**
    ...
    public static Response postAsyn(String url, Map<String, String> params) throws IOException
    {
    ...
    public static void postAsyn(String url, final ResultCallback callback, Map<String, String> params)
    {
        getInstance()._postAsyn(url, callback, params);
        Gson gson = new Gson();
        Log.i("POST: " + url, gson.toJson(params));
    }
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback()
        {
            ...
            public void onResponse(final Response response)
            {
                try
                {
                    ...
                    Log.i("url", response.request().url().getPath());
                    Log.i("result", string);
                    if (callback.mType == String.class)
                    {
                        sendSuccessResultCallback(string, callback);
                    } else if (callback.mType == Map.class) {
